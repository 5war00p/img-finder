      ...
      <div className="relative flex h-16 items-center justify-between">
        <div className="flex sm:items-stretch sm:justify-start">
          <a
            href="/"
            className={
              "text-white hover:bg-[rgba(217, 217, 217, 0.12)] rounded-md px-3 py-2 text-sm font-medium"
            }
          >
            Homepage
          </a>
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          <div className="flex space-x-4">
            <button className="text-white hover:bg-[rgba(217, 217, 217, 0.12)] rounded-md px-3 py-2 text-sm font-medium">
              Login
            </button>
